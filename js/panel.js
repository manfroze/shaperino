menu = ["options", "achievements", "debug"]
...
panelContent = {
	options: '<div class="container"><div id="save" class="button small">save</div> <div id="load" class="button small">load</div> <div id="reset" class="button small">reset</div></div><div class="container"><div id="colorblind" class="button small">colorblind mode <span>'+ options.colorblind +'</span></div></div>',
